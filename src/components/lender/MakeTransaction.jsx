            ...
            <form onSubmit={onSubmit} className="flex flex-col gap-10 p-8 bg-gray-200 rounded-xl">
                ...
                <div className="flex gap-5">
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        <input type="number" name="amount" onChange={handleInputChange} className="rounded-md px-4 py-1.5 bg-gray-100" />
                    </div>
                </div>
                <div className="flex gap-5">
                    <div className="flex flex-col gap-1">
                        <label htmlFor="notes" className="text-gray-500 font-medium">Date</label>
                        <input type="date" name="date" onChange={handleInputChange} className="rounded-md px-4 py-2 bg-gray-100" />
                    </div>
                </div>
                <div className="flex gap-5">
                    <div className="flex flex-col gap-1">
                        <label htmlFor="notes" className="text-gray-500 font-medium">Note</label>
                        <input type="text" name="notes" onChange={handleInputChange} className="rounded-md px-4 py-2 bg-gray-100 w-80" />
                    </div>
                </div>
